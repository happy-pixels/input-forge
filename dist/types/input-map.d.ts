 ...
 * ```
 */
export type SingleInputEntry = RequireAtLeastOne<SingleInputEntryBase, 'keyboardInput' | 'controllerInput' | 'systemInput' | 'customInput'>;
/**
 ...
 * ```
 */
export type AxesInputEntry = RequireAtLeastOne<AxesInputEntryBase, 'keyboardAxes' | 'controllerStick' | 'customAxesInput'>;
/**
